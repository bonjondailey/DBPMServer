namespace UpgradeHelpers.Helpers
{
    ...
    public class NotUpgradedHelper
    {
        ...
        public static void NotifyNotUpgradedElement(string notUpgradedElementName)
        {
            ...
            {
                _reporting = true;
                 System.Windows.Forms.DialogResult res = System.Windows.Forms.MessageBox.Show(Message1 + notUpgradedElementName + Message2, Title + notUpgradedElementName, System.Windows.Forms.MessageBoxButtons.YesNoCancel);
                _reporting = false;
                switch (res)
                {
        ...
        public static void NotifyNotUpgradedElement(string NotUpgradedElementName)
        {
            ...
            {
                _reporting = true;
                System.Windows.MessageBoxResult res = System.Windows.MessageBox.Show(Message1 + NotUpgradedElementName + Message2, Title + NotUpgradedElementName, System.Windows.MessageBoxButton.YesNoCancel);
                _reporting = false;
                switch (res)
                {
